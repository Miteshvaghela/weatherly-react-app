...
const index = () => {
  return (
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            ...
            <div className="space-y-8 md:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div>
                    <div className="m-auto flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 className="mb-2 text-xl text-center font-bold dark:text-white">Marketing</h3>
                    <p className="text-gray-500 dark:text-gray-400 text-center">Plan it, create it, launch it. Collaborate seamlessly with all  the organization and hit your marketing goals every month with our marketing plan.</p>
                </div>
                <div>
                    <div className="m-auto flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 className="mb-2 text-xl text-center font-bold dark:text-white">Legal</h3>
                    <p className="text-gray-500 dark:text-gray-400 text-center">Protect your organization, devices and stay compliant with our structured workflows and custom permissions made for you.</p>
                </div>
                <div>
                    <div className="m-auto flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 className="mb-2 text-xl text-center font-bold dark:text-white">Business Automation</h3>
                    <p className="text-gray-500 dark:text-gray-400 text-center">Auto-assign tasks, send Slack messages, and much more. Now power up with hundreds of new templates to help you get started.</p>
                </div> 
            </div>
        </div>
        </section>
